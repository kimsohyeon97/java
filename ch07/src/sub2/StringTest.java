...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		// 문자열(문자+배열) 생성
		String str1 = "Hello"; // 리터럴 방식, String은 클래스 str1은 객체
		...
		System.out.println("message의 길이 : " + message.length());
		...
		System.out.println("message 문자열 0~5까지 문자열 : " + sub1); // 5번째 전까지 프린트
